...
export default function HealthyBacklogDashboard() {
  ...
  const CSV_URL = 'https://raw.githubusercontent.com/YOUR_USERNAME/YOUR_REPO/main/Healthy_Backlog_Limits_-_For_HBL_Dashboard.csv';
  ...
  const fetchData = async () => {
    ...
    try {
      ...
      if (!response.ok) {
        throw new Error('Failed to fetch data. Please check the file URL.');
      }
          ...
          {error && (
            <div className="mt-4 bg-red-50 border border-red-200 rounded-lg p-4">
              ...
              <p className="text-xs text-red-600 mt-2">
                Update the CSV_URL in the code to point to your GitHub raw file URL
              </p>
            </div>
          )}
        </div>
